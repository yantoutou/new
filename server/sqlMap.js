...
var sqlMap = {
    ...
    message: {
       list: 'select * from unMessage limit 0,10',
       total: 'select * from unMessage',
       page: 'select * from unMessage limit ?,10',
       search: 'select * from unMessage where number = ?',
       searchPage: 'select * from unMessage where number = ? limit ?,10',
       deleteNum: 'delete from unMessage where number = ?'
    },
    sale: {
